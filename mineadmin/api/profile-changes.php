...
switch ($action) {
    ...
    case 'reject':
        ...
        try {
            ...
            $familyFields = ['father_name', 'father_occupation', 'mother_name', 'mother_occupation', 'brothers', 'brothers_married', 'sisters', 'sisters_married', 'family_type', 'family_status', 'gotra', 'parents_address', 'parents_address_type', 'about_family'];
            $familyUpdates = [];
            $familyParams = [];
